...
$paypal[business]="fundrising@afsoh.com";
$paypal[site_url]="http://www.afsoh.com/";
$paypal[image_url]="";
//$paypal[success_url]="success.php";
//$paypal[success_url]="ipn/ipn.php";
$paypal[cancel_url]="cancelled.php";
...
$paypal[continue_button_text]="Continue to finish this payment >>";
