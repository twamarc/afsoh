...
<head>
	...
	<?php
	//automatische refresh zodat aanpassingen in de fotolijst ook worden weergegevn
	if(!isset($_GET[ok])) {
	?>
	<script type="text/javascript">
     window.location.href="image.php?ok=ok";
    </script>
    <noscript>
      <meta http-equiv="refresh" content="0;url=image.php?ok=ok" />
     </noscript>
	 <?php
	 }
	 ?>
				...
				<fieldset>
						...
						<table class="properties">
							...
							<tr>
								...
								<td><select id="src_list" name="src_list" onchange="document.getElementById('src').value=this.options[this.selectedIndex].value;document.getElementById('alt').value=' ';document.getElementById('title').value=this.options[this.selectedIndex].text;ImageDialog.showPreviewImage(this.options[this.selectedIndex].value);"></select></td>
							</tr>
							<tr>
								<td><label for="src_list"></label></td>
								<td>add images to this list at the "upload image" page</td>
							</tr>
							<tr> 
